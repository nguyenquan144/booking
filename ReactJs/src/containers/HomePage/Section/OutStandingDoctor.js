...
class OutStandingDoctor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {//checl thay doi tu update
    ...
    handleViewDetailDoctor = (doctor) => {
        if (this.props.history) {
            this.props.history.push(`/detail-doctor/${doctor.id}`)// click doctor render trang user co doctorid
